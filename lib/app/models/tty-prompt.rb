...
@@client = Alphavantage::Client.new key: "NZYSJMCTOOP2IZ1Q"
  ...
  def self.prompts
    ...
    function =  self.prompt.select("Enter function you would like to use!",["SYMBOL_SEARCH","OVERVIEW","GLOBAL_QUOTE","Buy Stock"])  
  ...
  #     elsif user_function =="Sell Stock"
  #       system("clear")
